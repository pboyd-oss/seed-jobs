...
pipelineJob('platform/${t.slug}/attest') {
    ...
    parameters {
        ...
        stringParam('PLATFORM_AUDIT_LOG_DIGEST', '', 'SHA-256 of correlated audit log')
        stringParam('PLATFORM_GIT_COMMIT',       '', 'Git commit SHA of the build')
        stringParam('PLATFORM_GIT_URL',          '', 'Git remote URL of the build')
